...
export const load = async (loadEvent) => { /* load is predefined function in sveltekit to load data in +page.svelte. 
loadEvent is a builtin parameters in load function to load data*/
    
    const {fetch} = loadEvent /* this destructured fetch is a built in function in sveltekit. It is the native fetch
