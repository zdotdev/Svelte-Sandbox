export const actions = {
	// actions is default variable in svelte for handling form actions
	default: async (defaultEvent) => {
		...
		if (!username || !password) {
			return {
				// unlike the +server, you don't have to return json(). All you need is just an object to handle error
