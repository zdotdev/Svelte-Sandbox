...
<p>
	Data invalidation is the way of updating dom by using invalidate. It deletes the current cache and
	re-ren the load function in this page, either +layout.js, +page.js, or +page.server.js. It keeps
	the dom up to date.
</p>
